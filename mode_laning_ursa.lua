...
function GetBack()
	--return false = bot will get back
	local npcBot=GetBot();
	...
	enemy,_=Utility.GetWeakestHero(800);
	if enemy==nil then
		return true;
	end

	if GetUnitToUnitDistance(npcBot,enemy)<=npcBot:GetAttackRange()+300 then
...
function Harass()
	...
	WeakestHero,Damage,Score = Utility.FindTarget(npcBot:GetAttackRange() + 400);
